...
function [Vm_snr] = BGdelayline_Isnr2snrfr(varargin);
...
Iext_snr = Iexc_snr*ones(nSNr,1);	% external input (pA) ** change this value to basal Isyn_snr input based on gp f.r.
